...
function CarouselComponent(){
    ...
    const deskImgUrl = ['../../public/assets/desktop-image-hero-1.jpg', '../../public/assets/desktop-image-hero-2.jpg', 
                    '../../public/assets/desktop-image-hero-3.jpg'];
    const mobileImgUrl = ['../../public/assets/mobile-image-hero-1.jpg', '../../public/assets/mobile-image-hero-2.jpg', 
                        '../../public/assets/mobile-image-hero-3.jpg'];
    ...
    const btn = <div className="btn-container">
        <button className="button" onClick={previous}>
            <img src="../../public/assets/icon-angle-left.svg" alt="" />
        </button>
        <button className="button" onClick={next}>
                <img src="../../public/assets/icon-angle-right.svg" alt="" />
            </button>
        </div>
    
    const promp = <a href="#" className="promp">Shop now <span><img src="../../public/assets/icon-arrow.svg" alt="" /></span></a>
